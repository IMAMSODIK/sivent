...
<body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="card">
                ...
                <div class="form-group row">
                    <label for="status_registrasi" class="col-sm-4 col-form-label">Status Registrasi</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="status_registrasi" placeholder="Status Registrasi" readonly>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="status_absensi" readonly>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="status_kit" class="col-sm-4 col-form-label">Status Kit</label>
                    <div class="col-sm-8">
                        <select name="" class="form-control" id="status_kit">
    ...
    <script>    
                        ...
                        if (response.status) {
                            ...
                            response.data.forEach(element => {
                                let row = [
                                    ...
                                    element.golongan,
                                    (element.status_registrasi) ? "Sudah Registrasi" : "Belum Registrasi",
                                    element.status_absensi,
                                    (element.status_kit) ? "Sudah Diambil" : "Belum Diambil",
                ...
                success: function(response){
                    if(response.status){
                        if(response.kategori_event == 'meeting'){
                            ...
                            $("#status_registrasi").val((response.data.status_registrasi) ? "Sudah Registrasi" : "Belum Registrasi");
        ...
        $("#simpan_absensi").on("click", function(){
            $.ajax({
                url: '/kit-peserta/daftar-peserta/kit',
                method: 'POST',
                data: {
                    "id": $("#id").val(),
