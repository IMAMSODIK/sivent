                                                        ...
                                                        <li class="pr-0 pl-0 pb-3 pt-3">
                                                            <div class="media"><img
                                                                ...
                                                                <div class="media-body"><a
                                                                        ...
                                                                        href="{{ asset('template/product.html') }}">Men
                                                                        Blue T-Shirt</a>
                                                                    <div class="qty-box">
                                                            ...
                                                            <div class="user-name">
                                                                <div>
                                                                    <h6><a class="f-w-500 f-14"
                                                                            href="{{ asset('template/user-profile.html') }}">Floyd
                                                                            Miles</a></h6><span
                                                    ...
                                                    <li>
                                                        <div class="user-alerts"><img
                                                            ...
                                                            <div class="user-name">
                                                                <div>
                                                                    <h6><a class="f-w-500 f-14"
                                                                            href="{{ asset('template/user-profile.html') }}">Willie
                                                    ...
                                                    <li>
                                                        <div class="user-alerts"><img
                                                            ...
                                                            <div class="user-name">
                                                                <div>
                                                                    <h6><a class="f-w-500 f-14"
                                                                            href="{{ asset('template/user-profile.html') }}">Jessica
                                                                            King</a></h6><span
                                                                        class="f-12 light-font"> commented on
                                                                        your photo </span><span
