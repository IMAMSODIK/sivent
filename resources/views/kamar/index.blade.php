                        ...
                        <div class="blog-details">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-2 d-flex justify-content-end">
                              <a href="/data-kamar/daftar-peserta?kegiatan_id={{$incoming->event_id}}"><button class="btn btn-secondary d-flex m-auto mb-2" type="button">Kunci Kamar</button></a>
                            </div>
                          </div>
                          <hr>
                  ...
                  <div class="card">
                    <div class="blog-box blog-grid text-center product-box">
                      ...
                      <div class="blog-details-main">
                        ...
                        <a href="/data-kamar/daftar-peserta?kegiatan_id={{$d->event_id}}"><button class="btn btn-secondary d-flex m-auto mb-4" type="button">Kunci Kamar</button></a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body dark-modal"> 
          ...
          <div class="card-footer text-end">
            <input class="btn btn-primary close-modal" type="button" id="close-flayer-2" value="Tutup">
          </div>
        </div>
      </div>
    </div>
