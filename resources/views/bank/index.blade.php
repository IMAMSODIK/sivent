...
@section('content')
                                ...
                                <table class="display" id="basic-1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-size: 20px">Nama Bank</th>
    ...
    <div class="modal fade bd-example-modal-lg" id="edit-data-modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myExtraLargeModal">Edit Bank</h4>
                    <button class="btn-close py-0" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body dark-modal">
                    <div class="card">
                        <form class="form theme-form dark-inputs">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            <label class="form-label" for="edit_nama_bank">Nama Bank</label>
                                            <input class="form-control input-air-primary" id="edit_nama_bank"
                                                type="text" placeholder="Nama Bank">
                                        </div>
                                    </div>
                                </div>
