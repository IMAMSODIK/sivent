                        ...
                        <div class="blog-details">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-2 d-flex justify-content-end">
                              <a href="/foto-event/daftar-foto?kegiatan_id={{$incoming->event_id}}"><button class="btn btn-secondary d-flex m-auto mb-2" type="button">Foto</button></a>
                            </div>
                          </div>
                          <hr>
                  ...
                  <div class="card">
                    <div class="blog-box blog-grid text-center product-box">
                      ...
                      <div class="blog-details-main">
                        ...
                        <a href="/foto-event/daftar-foto?kegiatan_id={{$d->event_id}}"><button class="btn btn-secondary d-flex m-auto mb-4***" type="button">Foto</button></a>
                      </div>
                    </div>
                  </div>
                </div>
