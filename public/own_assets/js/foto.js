...
$(".edit").on("click", function(){
    ...
    $.ajax({
        url: '/foto-event/daftar-foto/edit',
        method: 'GET',
        data: {
            'id': id
        },
        success: function(response){
            if(response.status){
                ...
                $("#foto_event").attr("src", "../../storage/foto/" + response.data.foto);
...
$("#update").on("click", function(){
    ...
    $.ajax({
        url: '/foto-event/daftar-foto/update',
        method: 'POST',
        processData: false,
        contentType: false, 
        data: formData,
...
$("#delete-confirmed").on("click", function(){
    $.ajax({
        url: '/foto-event/daftar-foto/delete',
        method: 'POST',
        data: {
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 d-flex justify-content-end">
                                                <a href="/foto-event/daftar-foto?kegiatan_id=${element.event_id}"><button class="btn btn-secondary d-flex m-auto mb-2" type="button">Foto</button></a>
                                            </div>
                                        </div>
                                        <hr>
                            ...
                            <div class="col-xl-4 xl-50 col-sm-6 box-col-6">
                                <div class="card">
                                    ...
                                    <div class="blog-details-main">
                                        ...
                                        <h6 class="blog-bottom-details">${element.nama_kegiatan}</h6>
                                        <p class="px-3">${element.deskripsi_kegiatan}</p>
                                        <a href="/foto-event/daftar-foto?kegiatan_id=${element.event_id}"><button class="btn btn-secondary d-flex m-auto mb-4" type="button">Foto</button></a>
                                    </div>
                                    </div>
                                </div>
                            </div>
